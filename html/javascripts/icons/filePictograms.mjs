// File and folder preview pictograms (256x256 SVGs for document type icons)
// These are separate from action icons due to their large size and specialized use case

export const FILE_PICTOGRAMS = {
	'folder-open-with-files': `
	...
	'file-spreadsheet': `
		...
		<defs>
			<linearGradient id="spreadsheetGrad" x1="0%" y1="0%" x2="100%" y2="100%">
				<stop offset="0%" stop-color="#1ABC9C"/>
				<stop offset="100%" stop-color="#007C3C"/>
			</linearGradient>
		</defs>
		<title>LibreOffice Calc</title>
		<path d="M9 13H7v-1h2v1zm6-3h-2v1h2v-1zm-6 0H7v1h2v-1zm3 0h-2v1h2v-1zm3-10 7 7V0h-7zM9 14H7v1h2v-1zm5 3h1v-3h-1v3zm2 0h1v-1h-1v1zm-4 0h1v-2h-1v2zm1-17 9 9v12c0 1.662-1.338 3-3 3H5c-1.662 0-3-1.338-3-3V3c0-1.662 1.338-3 3-3h8zm5 13h-7v5h7v-5zm-2-4H6v7h4.5v-1H10v-1h.5v-1H10v-1h2v.5h1V12h2v.5h1V9z" fill="url(#spreadsheetGrad)"/>
		</svg>
	`,
	'file-text': `
		<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
		<defs>
			<linearGradient id="textGrad" x1="0%" y1="0%" x2="100%" y2="100%">
				...
				<stop offset="100%" stop-color="#083FA6"/>
			</linearGradient>
		</defs>
		<title>LibreOffice Writer</title>
        <path d="M22 0v7l-7-7h7zm0 9v12c0 1.662-1.338 3-3 3H5c-1.662 0-3-1.338-3-3V3c0-1.662 1.338-3 3-3h8l9 9zM6 10h5V9H6v1zm0 2h5v-1H6v1zm0 2h5v-1H6v1zm5 3H6v1h5v-1zm7-2H6v1h12v-1zm0-6h-6v5h6V9zm-1.5 2a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1zM14 11l-1 2h3l-2-2z" fill="url(#textGrad)"/>
        </svg>
	`,
	'file-presentation': `
		<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
	...
	'file-default': `
		...
		<defs>
			<linearGradient id="defaultGrad" x1="0%" y1="0%" x2="100%" y2="100%">
				...
				<stop offset="100%" stop-color="#7324A9"/>
			</linearGradient>
		</defs>
...
export function getFilePictogram(key) {
	return FILE_PICTOGRAMS[key] || '';
}

export function hasFilePictogram(key) {
	return key in FILE_PICTOGRAMS;
}
