...
module.exports = {
	stateRoot: path.resolve(process.env.WOPI_STATE_ROOT || DEFAULT_WOPI_STATE_ROOT),
	mountRoot: path.resolve(process.env.MOUNT_ROOT || DEFAULT_MOUNT_ROOT),
	templateRoot: path.resolve(process.env.TEMPLATE_ROOT || '/templates'),
	...
	activityMaxAgeDays: parsePositiveInteger(process.env.ACTIVITY_MAX_AGE_DAYS, 180, 'ACTIVITY_MAX_AGE_DAYS'),
	activityMaxCount: parsePositiveInteger(process.env.ACTIVITY_MAX_COUNT, 60, 'ACTIVITY_MAX_COUNT'),
	versionMaxAgeDays: parsePositiveInteger(process.env.VERSION_MAX_AGE_DAYS, 365, 'VERSION_MAX_AGE_DAYS'),
	versionMaxCount: parsePositiveInteger(process.env.VERSION_MAX_COUNT, 36, 'VERSION_MAX_COUNT'),
